(function(){
  ...
  const myQuestions = [
    ...
    {
      question: "3) ___________é a área do conhecimento que visa  a melhorar a qualidade de vida e a desenvolver e a desenvolver as habilidades pessoais de cada pessoa.",
      answers: {
