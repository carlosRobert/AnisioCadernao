(function(){
  ...
  const myQuestions = [
    {
      question: "1) Onde surgiu a ginástica?",
      answers: {
        a: "Itália",
        b: "Alemanha",
        c: "Grécia Antiga",
    ...
    {
      question: "2) Que tipo de Exercícios são recomendados antes das práticas de Esportes, Lutas, Corridas dentre outros esforços físico para se evitar Lesões?",
      answers: {
        a: "Equilíbrios",
        b: "Alongamentos",
        c: "Relaxamentos",
    ...
    {
      question: "3) Andar, correr, saltar e saltitar são habilidades motoras de:",
      answers: {
        a: "Manipulação",
        b: "Estratificação",
        c: "Locomoção",
